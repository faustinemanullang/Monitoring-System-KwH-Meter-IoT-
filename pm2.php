...
function getDataFromDatabase($conn, $startDate, $endDate)
{
	...
	$sql = "SELECT * FROM pm2 WHERE time BETWEEN '$startDate' AND '$endDate' ORDER BY time";
	static $data;
...
<body>
		...
		<div id="content">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="container-fluid mb-2">
					...
					<div id="judul" style="text-align:center">
						<div>DATA LOG POWER METER 2</div>
						<div>Periode
			...
			<div class="cardBox">
				<form method="post" action="export.php">
					...
					<input type="hidden" name="pm" value="2">
	...
	<script>
		const upd = () => {
			window.location.href = 'http://localhost/mockup/pm2.php'
			console.log("fire");
		}
